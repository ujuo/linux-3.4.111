...
#define NETIF_F_HW_VLAN_CTAG_TX_BIT			NETIF_F_HW_VLAN_TX_BIT	/* Transmit VLAN hw acceleration */
#define NETIF_F_HW_VLAN_CTAG_RX_BIT			NETIF_F_HW_VLAN_RX_BIT		/* Receive VLAN hw acceleration */
